...
import os, json, time, uuid, sqlite3, tempfile
import requests
...
# ── Use cross-platform temp directory (Windows compatible) ────────────────────
DB_PATH = os.path.join(tempfile.gettempdir(), "fitplan_plans.db")
